...
# 6. Cálculo de IMC (Índice de Massa Corporal)
...
- Regras:
  O assistente deve calcular automaticamente o IMC do usuário.
  O IMC deve ser exibido no início do plano alimentar.
  O IMC deve ser usado como contexto auxiliar na montagem da dieta.
  O IMC não deve ser utilizado isoladamente para definir composição corporal.
